...
public class Teste02 extends Application {
	...
	public static double phase(double[] t,double[] v) {				// Compute phase
		...
		public static void main(String[] args) throws IOException, ParseException{
			...
			for (int j=0;j<2;j++){
				...
				date = format.parse(dayString[j]);
				//System.out.println(date); // Sat Jan 02 00:00:00 GMT 2010			
				higro2.add(date,timeS,tempS,humiS,stateS);

				try (BufferedReader br = new BufferedReader(new FileReader("C:/Users/Rui Barros Garcia/Desktop/EDP_ReDy/data/" + dayString[j] + "_ext.csv")))
				{
					...
					while ((sCurrentLine = br.readLine()) != null) {
						...
						if (i!=-1){
							...
							higro2.feed(higro2.last, Double.parseDouble(data[0]), Double.parseDouble(data[1]), Double.parseDouble(data[2])," ");
